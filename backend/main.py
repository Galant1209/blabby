...
async def payment_callback(request: Request):
    ...
    # See ecpay.parse_ecpay_form's docstring.
    try:
...
async def admin_practice_volume(
    ...
    Scale caveat: PostgREST caps .data at 1000
...
# line_graph reinstated 2026-07-06 at 5/5 after the truth-harness assertions
# were corrected (its 0/5 was two assertion false-negatives, not bad rendering).
